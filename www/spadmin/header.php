<?php
  ...
  define('MODE','prod');
    ...
    switch(MODE) {
        case 'prod':
            $server_url = 'topforexsignal.com';
            break;
        case 'stage':
            $server_url = 'stage.topforexsignal.com';
...
<link href="http://<? echo $server_url; ?>/theme/css/admin.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" href="<? echo $server_url; ?>/assets/jquery-ui.css" type="text/css" />
<script type="text/javascript" src="<? echo $server_url; ?>/assets/js/jquery.js"></script>
<script type="text/javascript" src="<? echo $server_url; ?>/assets/js/jquery-ui.js"></script>
<script src="<? echo $server_url; ?>/assets/js/jquery.ui.touch-punch.js"></script>
<script src="<? echo $server_url; ?>/assets/js/jquery.wysiwyg.js"></script>
<script src="<? echo $server_url; ?>/assets/js/global.js"></script>
<script src="<? echo $server_url; ?>/assets/js/custom.js"></script>
<script src="<? echo $server_url; ?>/assets/js/modernizr.mq.js" type="text/javascript" ></script>
<script src="<? echo $server_url; ?>/assets/js/checkbox.js"></script>
<script src="<? echo $server_url; ?>/assets/js/menu.js"></script>
</head>
<body>
...
<div id="crumbs">
  <div class="container">
    <div class="row grid_24 clearfix">
      <div class="col grid_16"> <i class="icon-dashboard"></i> <a href="index.php">Dashboard</a> <i class="icon-angle-right"></i>
        ...
        <ul class="cbp-hsmenu">
          ...
          <li><a title="Configuration"><i class="icon-cog"></i> Configuration</a>
            <ul class="cbp-hssubmenu">
              ...
              <li><a href="index.php?do=fields" title="Custom Fields"><i class="icon-th-list"></i><span>Custom Fields</span></a></li>
          ...
          <li><a href="index.php?do=signals" title="User Management"><i class="icon-warning-sign"></i> Signals Management</a></li>
