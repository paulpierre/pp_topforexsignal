...
<head>
    ...
    <!-- **CSS - stylesheets** -->
    <link id="default-css" href="http://www.topforexsignal.com/lp/css/style.css" rel="stylesheet" media="all" />
    <link href="http://www.topforexsignal.com/lp/css/responsive.css" rel="stylesheet" media="all" />
...
<header id="header">
    <div class="container">
        <div id="logo">
            <a href="/"> <img src="http://www.topforexsignal.com/lp/img/logo.png" alt="" title=""> </a>
        </div>
...
<h1 style="padding-top:30px;">Sign up here to receive free forex signals!</h1>
<h2 style="display:none;">Join our mailing list to receive free forex signals & tips!</h2>
...
<div style="display: none;">
    <input type="hidden" name="meta_web_form_id" value="1125929737" />
    ...
    <input type="hidden" name="meta_adtracking" value="PreLaunch_Survey" />
    <input type="hidden" name="meta_message" value="1" />
    <input type="hidden" name="meta_required" value="name,email,custom Country,custom Own a Forex Trading Account,custom Trading Account Size" />

    <input type="hidden" name="meta_tooltip" value="custom Country||Pick a country" />
</div>
<div id="af-form-1125929737" class="af-form"><div id="af-header-1125929737" class="af-header"><div class="bodyText"><p>&nbsp;</p></div></div>
<div id="af-body-1125929737"  class="af-body af-standards">
<div class="af-element">
    <label class="previewLabel" for="awf_field-68842501">Name: </label>
    <div class="af-textWrap">
        <input id="awf_field-68842501" type="text" name="name" class="text" value=""  onfocus=" if (this.value == '') { this.value = ''; }" onblur="if (this.value == '') { this.value='';} " tabindex="500" />
    </div>
    <div class="af-clear"></div></div>
<div class="af-element">
    <label class="previewLabel" for="awf_field-68842503">Email: </label>
    <div class="af-textWrap"><input class="text" id="awf_field-68842503" type="text" name="email" value="" tabindex="501" onfocus=" if (this.value == '') { this.value = ''; }" onblur="if (this.value == '') { this.value='';} " />
    </div><div class="af-clear"></div>
</div>
<div class="af-element">
<label class="previewLabel" for="awf_field-68842504">Your country:</label>
<div class="af-selectWrap"><select id="awf_field-68842504" name="custom Country" tabindex="502" >
...
</div><input type="hidden" name="meta_preselected_awf_field-68842504" value=""/><div class="af-clear"></div></div><div class="af-element"><div><label class="previewLabel" for="awf_field-688425050">Do you have a Forex Trading Account:</label><div class="choiceList choiceList-radio-stacked">

    <div class="af-element-radio multiChoice" style="display:inline-block;">

        <input class="radio" type="radio" id="awf_field-688425050" name="custom Own a Forex Trading Account"  value="Yes" tabindex="503" />
        <label class="choice" for="awf_field-688425050">Yes</label>
    </div>
    <div class="af-element-radio multiChoice" style="display:inline-block;">
        <input class="radio" type="radio" id="awf_field-688425051" name="custom Own a Forex Trading Account"  value="No" tabindex="504" />
        <label class="choice" for="awf_field-688425051">No</label>

        <div class="af-clear"></div>
    </div>

    <div class="af-element-radio multiChoice" style="display:inline-block;">
        <input class="radio" type="radio" id="awf_field-688425052" name="custom Own a Forex Trading Account"  value="Not Sure" tabindex="505" />
        <label class="choice" for="awf_field-688425052">Not Sure</label>
        <div class="af-clear"></div></div></div></div><div class="af-clear"></div></div><div class="af-element">
    <label class="previewLabel" for="awf_field-68842502">Trading Account Size:</label>
    <div class="af-selectWrap"><select id="awf_field-68842502" name="custom Trading Account Size" tabindex="506" >
        <option class="multiChoice" value="Less than $500">Less than $500</option>
        <option class="multiChoice" value="$500 to $999">$500 to $999</option>
        <option class="multiChoice" value="$1,000 to $1999">$1,000 to $1999</option>
        <option class="multiChoice" value="$2,000 to $2999">$2,000 to $2999</option>
        <option class="multiChoice" value="$5,000 and more">$5,000 and more</option>
    </select>
    </div><input type="hidden" name="meta_preselected_awf_field-68842502" value="$3,000 to $4,999"/><div class="af-clear"></div></div><div class="af-element">
    <label class="previewLabel" for="awf_field-68842507">Experience in Forex Trading:</label>
    <div class="af-selectWrap"><select id="awf_field-68842507" name="custom Experience in Forex Trading" tabindex="507" >
        <option class="multiChoice" value="No experience">No experience</option>
        <option class="multiChoice" value="Less than 6 months">Less than 6 months</option>
        <option class="multiChoice" value="6 months to 12 months">6 months to 12 months</option>
        <option class="multiChoice" value="More than a year">More than a year</option>
        <option class="multiChoice" value="2 years and above">2 years and above</option>
    </select>
    </div><input type="hidden" name="meta_preselected_awf_field-68842507" value=""/><div class="af-clear"></div></div><div class="af-element buttonContainer">
    <input name="submit" id="af-submit-image-1125929737" type="image" class="image" style="border-style:none;background: none; max-width: 100%;" alt="Submit Form" src="http://www.topforexsignal.com/lp/img/submit.png" tabindex="508" />
    <div class="af-clear"></div>
</div>
</div>
<div id="af-footer-1125929737" class="af-footer"><div class="bodyText"><p>&nbsp;We do not ever sell your email to anyone. That's a guarantee.</p></div></div>
</div>
<div style="display: none;"><img src="http://forms.aweber.com/form/displays.htm?id=jIxMrJxMnOzM7A==" alt="" /></div>
