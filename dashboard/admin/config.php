...
<form class="xform" id="admin_form" method="post">
  ...
  <div class="row showsmail">
    <section class="col col-6">
      <label class="input"> <i class="icon-prepend icon-asterisk"></i> <i class="icon-append icon-exclamation-sign  tooltip" data-title="Ask your hosting company for sandmail path if unsure. Usually: /usr/sbin/sendmail -t -i"></i>
        <input type="text" name="sendmail" value="<?php echo $core->sendmail;?>" placeholder="Sendmail Path">
      </label>
      <div class="note note">Sendmail Path</div>
    </section>
  </div>
