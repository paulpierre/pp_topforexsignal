...
<form class="xform" id="admin_form" method="post">
  ...
  <div class="row">
    <section class="col col-4">
      <label class="input state-disabled"> <i class="icon-prepend icon-calendar"></i>
        <input type="text" name="created" disabled="disabled" readonly value="<?php echo $row->created;?>" placeholder="Email">
      </label>
      <div class="note">Registration Date:</div>
    </section>
    <section class="col col-4">
      <label class="input state-disabled"> <i class="icon-prepend icon-calendar"></i>
        <input type="text" name="lastlogin" disabled="disabled" readonly value="<?php echo $row->lastlogin;?>" placeholder="First Name">
      </label>
      <div class="note">Last Login</div>
    </section>
    <section class="col col-4">
      <label class="input state-disabled"> <i class="icon-prepend icon-laptop"></i>
        <input type="text" name="lastip" disabled="disabled" readonly value="<?php echo $row->lastip;?>" placeholder="Last Name">
      </label>
  ...
  <div class="row">
    <section class="col col-12">
      ...
      <div class="note note-info">Send welcome email to this user. Password will be reset.</div>
    </section>
  </div>
  <div class="row">
    <section class="col col-12">
...
<form class="xform" id="admin_form" method="post">
  ...
  <?php echo $core->rendertCustomFields('profile', false);?>
  <div class="row">
    <section class="col col-12">
      <label class="textarea">
    ...
    <table class="myTable">
      <thead>
        <tr>
          ...
          <th class="header">4X APPROVED</th>
          <th class="header" style="display:none;">Signal Provider</th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
          <? $traderStatus = getStatusByID($row->id);
              if($traderStatus > 1) {
          ?>
          <? } else { ?>
                  <span class="tbicon" style="width:auto;padding:5px 7px 5px 7px;background-color:#84b444;"> <a href="index.php?do=users&amp;action=edit&amp;id=<?php echo $row->id;?>" class="tooltip Approve " data-title="Approve this account with 4X Solutions"><i class="icon-ok"></i> Approve to trade</a> </span>
          <? } ?>
          </td>
          <td style="display:none;">
              <span class="tbicon" style="width:auto;padding:5px 7px 5px 7px;background-color:#555;"> <a href="index.php?do=users&amp;action=edit&amp;id=<?php echo $row->id;?>" class="tooltip Approve " data-title="Make this account a signal provider"> Change to SP</a> </span>
