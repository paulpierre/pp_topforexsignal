  ...
  <div class="topheader">
    <nav class="cbp-hsmenu-wrapper" id="cbp-hsmenu-wrapper">
      <div class="cbp-hsinner">
        <ul class="cbp-hsmenu">
          <li><a href="index.php?do=users" title="User Management"><i class="icon-user"></i> Trader Management</a></li>
            <li><a href="index.php?do=commissions" title="User Management"><i class="icon-money"></i> Commissions</a></li>
