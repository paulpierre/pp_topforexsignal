<?php
  ...
  class timthumb
  {
      ...
      public function __construct()
      {
          ...
          /*
          if (array_key_exists('HTTP_REFERER', $_SERVER) &&  (!preg_match('/^https?:\/\/(?:www\.)?' . $this->myHost . '(?:$|\/)/i', $_SERVER['HTTP_REFERER'])) &&  (!preg_match('/^https?:\/\/(?:www\.)?' . 'dashboard.' . '(?:$|\/)/i', $_SERVER['HTTP_REFERER']))) {
