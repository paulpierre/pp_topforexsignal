  ...
  class Core
  {
      ...
      public function processConfig()
      {
          ...
          switch($_POST['mailer']) {
              ...
              Filter::checkPost('smtp_port', "Please enter Valid SMTP Port!");
				  break;
			  
			  case "SMAIL" :
				  Filter::checkPost('sendmail', "Please enter Valid Sendmail Path!");
			  break;
		  }
	  ...
	  {
		  Filter::checkPost('title', "Please Enter Field Name!");
		  ...
		  if (empty(Filter::$msgs)) {
              ...
              $message = (Filter::$id) ? '<span>Success!</span>Field updated successfully!' : '<span>Success!</span>Field added successfully!';
	   ...
	   * @return
	   */
	  public function rendertCustomFields($type, $data, $wrap = 6)
	  {
		  ...
		  . "\n ORDER BY sorting")) {
			  ...
			  foreach ($fdata as $id => $cfrow) {
                  ...
                  $req = ($cfrow->req) ? ' note-error' : null;
				  $tip = ($cfrow->tooltip) ? ' <i class="icon-exclamation-sign  tooltip" data-title="' . $cfrow->tooltip . '"></i>' : null;
				  $html .= '<section class="col col-' . $wrap . '">';
				  ...
				  $html .= '<input name="custom_' . $cfrow->name . '" type="text" placeholder="' . $cfrow->title . '" value="' . $value[$id] . '">';
				  $html .= '</label>';
				  $html .= '<div class="note' . $req . '">' . $cfrow->title . $tip . '</div>';
				  $html .= '</section>';
