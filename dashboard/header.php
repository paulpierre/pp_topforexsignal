...
<div class="col grid_16">
    <div id="usermenu" class="flright"> <a href="index.php"><i class="icon-home"></i> Dashboard</a> <a href="contact.php"><i class="icon-envelope"></i> Contact Us</a>
    <?php if($user->logged_in):?>
    <a href="logout.php"><i class="icon-off"></i> Log Off</a>
    <?php endif;?>
    <?php if(!$user->logged_in):?>
    <a href="plans.php" style="display:none;"><i class="icon-group"></i> Membership Packages</a>
    <?php endif;?>
